  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-black">
      <div className="flex flex-col items-center justify-center w-[430px] h-[932px] bg-white p-5">
        <Image src={SuccessImage} alt="Success" width={300} height={200} />

        <h1 className="text-2xl font-bold my-5">Splitly Success!</h1>

        <p className="text-sm text-gray-500 mb-5">Share your Session ID & code with your friends</p>
        ...
        <div className="flex flex-col space-y-3 w-full max-w-xs">
          ...
          <input 
            ...
            required
          />
          {error.id && <p className="text-red-500 text-xs">Session ID is required.</p>}
          ...
          <input 
            ...
            required
          />
          {error.code && <p className="text-red-500 text-xs">Session code is required.</p>}
        </div>

        <p className="text-xs text-gray-400 my-5">Session expired at Aug. 22, 2024 - 12:01 PM</p>
        ...
        <button 
          className={`w-full py-3 text-center rounded-lg my-3 ${!sessionId || !sessionCode ? 'opacity-50 cursor-not-allowed' : ''}`}
          onClick={() => {
            if (handleValidation()) {
